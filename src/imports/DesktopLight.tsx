import svgPaths from "./svg-0t0xv52cvv";
...
function Frame() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex font-['Inter:Regular',sans-serif] font-normal gap-[47px] items-center leading-[normal] left-1/2 not-italic text-[#001c56] text-[14px] top-[calc(50%+0.5px)]">
